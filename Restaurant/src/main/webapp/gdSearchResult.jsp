<%-- 
    Document   : gdSearchResult
    Created on : Dec 18, 2021, 7:51:03 PM
    Author     : thuan
--%>
    ...
    <body>
        <div align="center">
            ...
            <form action="luuphong" method="post">
                ...
                <input type="hidden" id="phongid" name="phongid" value="${datPhong.phongid}"/>                
                <c:forEach items="${datPhong.nhanviencaids}" var="nvcaid">
                    <input type="hidden" name="nhanviencaid" value="${nvcaid}" required>
                </c:forEach>
                <table style="width: 50%">
                    ...
                    <c:forEach items="${datPhong.khList}" var="x">
                        <tr>
                            ...
                            <td align="center">                                                         
                                <input type="radio" name="khachhangid" value="${x.maKH}" />Chon
                            </td>
                        </tr> 
                    </c:forEach>
                </table>
